...
function StudentManagement({ students, setStudents }) {
  ...
  return (
    <div>
      ...
      <div className="mb-4">
        <input value={search} onChange={e => setSearch(e.target.value)} placeholder="Search by name, roll, or divisionGÇª"
    ...
    <div>
      ...
      {modal && (
        <Modal title="New Assignment" onClose={() => setModal(false)}>
          ...
          <Textarea label="Description" value={form.desc}     onChange={e => setForm(f => ({ ...f, desc:     e.target.value }))} placeholder="Assignment detailsGÇª" />
